...
export const config = {
  ...
  timeline: [
    { time: '17:00', title: 'Церемония',         desc: 'Самый трогательный момент: официальное оформление нашей любви. Будем счастливы видеть ваши улыбки в зале. На всякий случай, приготовьте платочки.' },
    ...
    { time: '00:00', title: 'Окончание банкета',      desc: 'Все хорошее рано или поздно заканчивается. Банкет подходит к концу, но тёплые воспоминания останутся с нами навсегда.' },
  ],
  dresscode: {
